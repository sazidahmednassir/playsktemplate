...
const TC_BY_TITLE = {
  "TC-2 Face mismatch on quiz start shows 'Face not matched'": { sheet: "Student", tcId: 2 },
};

test.describe("Student | Proctoring Pro | TC-2", () => {
  ...
  test("TC-2 Face mismatch on quiz start shows 'Face not matched'", async ({
    actions,
  }) => {
